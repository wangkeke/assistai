      ...
      <UCard :ui="{ divide: 'divide-y divide-gray-100 dark:divide-gray-800' }">
        ...
        <!-- Content -->
          <div class="flex flex-row gap-3 leading-6 items-center mt-4">
            <label for="title" class=" basis-1/6 text-sm font-medium leading-6 text-gray-900">会话标题</label>
            <div class="grow">
                <UInput maxlength="500" id="topic-title" v-bind:value="title" icon="i-heroicons-chat-bubble-left-ellipsis" color="gigas" variant="outline" :trailing="false" class="block w-full disabled:text-gray-400 rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-inset focus:ring-2 focus:ring-gigas-500 sm:text-sm sm:leading-6"/>
            </div>
          </div>
          <div class="flex flex-row gap-3 leading-6 items-center mt-4">
            <label for="email" class=" basis-1/6 text-sm font-medium leading-6 text-gray-900">记住最近会话轮数</label>
            <div class="grow">
                <USelect id="topic-turn" required v-bind:value="turn" :options="turns" color="gigas" variant="outline" class="block w-full disabled:text-gray-400 rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-inset focus:ring-2 focus:ring-gigas-500 sm:text-sm sm:leading-6"/>
            </div>
          </div>
        <template #footer>
          <!-- Content -->
