        ...
        <UCard :ui="{ divide: 'divide-y divide-gray-100 dark:divide-gray-800' }">
          ...
          <!-- Content -->
            <div class="flex flex-row gap-3 leading-6 items-center mt-4">
              <label for="email" class=" basis-1/6 text-sm font-medium leading-6 text-gray-900">邮箱地址</label>
              <div class="grow">
            ...
            <div class="flex flex-row gap-3 leading-6 items-center mt-4">
              <label for="nickname" class="basis-1/6 text-sm font-medium leading-6 text-gray-900">姓名昵称</label>
              <div class="grow">
