...
<script setup>
    ...
    async function sendEmailCode(){
        ...
        await useFetch(useRuntimeConfig().public.apiBase + "/user/send_email_reset_code", {
            method: 'post',
    ...
    async function checkEmailCode(){
        ...
        await useFetch(useRuntimeConfig().public.apiBase + "/user/verify_email_reset_code", {
            method: 'post',
    ...
    async function resetpwd(){
        ...
        await useFetch(useRuntimeConfig().public.apiBase + "/user/reset_password", {
            method: 'post',
