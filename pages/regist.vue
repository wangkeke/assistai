...
<script setup>
    ...
    async function sendEmailCode(){
        ...
        await useFetch(useRuntimeConfig().public.apiBase + "/send_email_regist_code", {
            method: 'post',
    ...
    async function checkEmailCode(){
        ...
        await useFetch(useRuntimeConfig().public.apiBase + "/verify_email_regist_code", {
            method: 'post',
    ...
    async function registUser(){
        ...
        await useFetch(useRuntimeConfig().public.apiBase + "/regist_user", {
            method: 'post',
